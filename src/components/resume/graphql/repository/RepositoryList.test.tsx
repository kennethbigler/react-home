  ...
  it('renders as expected', () => {
    render(
      <MockedProvider mocks={[]} addTypename={false}>
        <RepositoryList repositories={repositories} loading fetchMore={jest.fn()} />
      </MockedProvider>,
    );
    ...
    expect(screen.getByText('Language: primaryLanguage - name')).toBeInTheDocument();
    expect(screen.getByText('Owner:')).toBeInTheDocument();
    expect(screen.getByText('owner - login')).toHaveAttribute('href', 'owner - url');
