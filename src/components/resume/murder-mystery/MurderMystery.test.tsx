...
describe('resume | murder-mystery | MurderMystery', () => {
  it('renders as expected', () => {
    ...
    expect(screen.getByText('Murder at The Grand Cinema Magic Hotel and Casino')).toBeInTheDocument();
    ...
    expect(screen.getByText('The Recently Fired Gladiator Actor')).toBeInTheDocument();
    ...
    expect(screen.getByText('The Professional Poker Player')).toBeInTheDocument();
