...
describe('resume | work | Work', () => {
  it('renders as expected', () => {
    ...
    expect(screen.getByText('Programming Language Timeline (Professional Use)')).toBeInTheDocument();
    ...
    expect(screen.getByText('Midnight Game Club, Sunnyvale, CA')).toBeInTheDocument();
    expect(screen.getByText('Frontend Software Engineer and Project Manager')).toBeInTheDocument();
  });
  ...
  it('expands and collapses on title click', () => {
    ...
    expect(screen.queryByText('Frontend Software Engineer and Project Manager')).toBeNull();
  });
});
