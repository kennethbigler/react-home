...
describe('resume | summary', () => {
  it('renders as expected', () => {
    ...
    expect(screen.getByText('Frontend Software Engineer, Intuit')).toBeInTheDocument();
    ...
    expect(screen.getByText('Developing useful, multi-platform software tools and creating user interfaces')).toBeInTheDocument();
    ...
    expect(screen.getAllByText('Santa Clara University, Santa Clara, CA')).toHaveLength(2);
    expect(screen.getByText('Master of Science in Computer Engineering')).toBeInTheDocument();
    ...
    expect(screen.getByText("The King's Academy, Sunnyvale, CA")).toBeInTheDocument();
  });
