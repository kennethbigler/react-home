...
describe('games | game-table | GameTable', () => {
  it('renders as expected with minimal props', () => {
    ...
    expect(screen.getByText('Ken: $1000').parentElement).toHaveStyle({ background: 'rgb(128, 222, 234)' });
  ...
  it('supports multiple hands', () => {
    const multiHandKen = { ...ken, hands: [...ken.hands, { cards: [{ name: 'Q', weight: 12, suit: '♥' }]}]};
    render(
      <GameTable
        onClick={jest.fn()}
