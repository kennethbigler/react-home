...
describe('games | blackjack | blackjackHelpers', () => {
  test('weighHand', () => {
    ...
    expect(weighHand([{ name: '4', suit: '♠' }])).toEqual({ weight: 0, soft: false });
  ...
  test('playBot | doubles', () => {
    ...
    const player = {
      soft: false,
      cards: [{ name: '7', suit: '♠', weight: 7 }, { name: '7', suit: '♠', weight: 7 }],
    };
    ...
    player.cards = [{ name: '4', suit: '♠', weight: 4 }, { name: '4', suit: '♠', weight: 4 }];
    playBot(player, dealer, double, hit, split, stay);
    expect(double).toHaveBeenCalledTimes(0);
    ...
    player.cards = [{ name: '5', suit: '♠', weight: 5 }, { name: '5', suit: '♠', weight: 5 }];
    playBot(player, dealer, double, hit, split, stay);
    ...
    player.cards = [{ name: '6', suit: '♠', weight: 6 }, { name: '6', suit: '♠', weight: 6 }];
    playBot(player, dealer, double, hit, split, stay);
    expect(double).toHaveBeenCalledTimes(1);
    ...
    player.cards = [{ name: '9', suit: '♠', weight: 9 }, { name: '9', suit: '♠', weight: 9 }];
    playBot(player, dealer, double, hit, split, stay);
    expect(double).toHaveBeenCalledTimes(1);
    expect(hit).toHaveBeenCalledTimes(4);
    ...
    player.cards = [{ name: 'A', suit: '♠', weight: 14 }, { name: 'A', suit: '♠', weight: 14 }];
    playBot(player, dealer, double, hit, split, stay);
    expect(double).toHaveBeenCalledTimes(1);
    expect(hit).toHaveBeenCalledTimes(4);
    ...
    player.cards = [{ name: 'K', suit: '♠', weight: 13 }, { name: 'K', suit: '♠', weight: 13 }];
    playBot(player, dealer, double, hit, split, stay);
    expect(double).toHaveBeenCalledTimes(1);
    expect(hit).toHaveBeenCalledTimes(4);
    expect(split).toHaveBeenCalledTimes(5);
  ...
  test('playBot | soft hands', () => {
    ...
    const player = {
      weight: 13,
      soft: true,
      cards: [{ name: 'A', suit: '♠', weight: 14 }, { name: '2', suit: '♠', weight: 2 }],
    };
  ...
  test('playBot | normal hands', () => {
    ...
    const player = {
      weight: 5,
      soft: false,
      cards: [{ name: '2', suit: '♠', weight: 2 }, { name: '3', suit: '♠', weight: 3 }],
    };
