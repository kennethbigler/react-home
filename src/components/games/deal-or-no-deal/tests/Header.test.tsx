...
describe('games | deal-or-no-deal | Header', () => {
  it('renders as expected', () => {
    render(<Header casesToOpen={1} isOver={false} newGame={jest.fn()} player={ken} />);
  ...
  it('changes appearance with a players choice', () => {
    render(<Header casesToOpen={1} isOver newGame={jest.fn()} player={ken} playerChoice={{ on: true, loc: 1, val: 1000 }} />);
