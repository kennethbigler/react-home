...
const drivers: Driver[] = [
  ...
  },
  {
    ...
    standings: [null, 8, 7, null, 19, 13, 16, 8, 15],
    thisYear: [0, 0, 0, 0, 1, 1, 5],
  },
  {
    ...
    thisYear: [0, 0, 0, 0, 0, 0, 1],
  },
  {
    name: "Kimi Antonelli",
    color: MERCEDES_HEX,
    points: [null, null, null, null, null, null, null, 150, 156],
    standings: [null, null, null, null, null, null, null, 7, 1],
    thisYear: [0, 18, 47, 72, 100, 131, 156],
  },
  {
    name: "Oliver Bearman",
    color: HAAS_HEX,
    points: [null, null, null, null, null, null, 7, 41, 18],
    standings: [null, null, null, null, null, null, 18, 13, 11],
    thisYear: [0, 6, 17, 17, 17, 18, 18],
  },
  {
    name: "Gabriel Bortoleto",
    color: AUDI_HEX,
    points: [null, null, null, null, null, null, null, 19, 2],
    standings: [null, null, null, null, null, null, null, 19, 17],
    thisYear: [0, 2, 2, 2, 2, 2, 2],
  },
  {
  ...
  },
  {
    ...
    color: ALPINE_HEX,
    points: [null, null, null, null, null, null, 5, 0, 15],
    standings: [null, null, null, null, null, null, 19, 20, 12],
    thisYear: [0, 0, 1, 1, 7, 15, 15],
  },
  {
    name: "Nyck De Vries",
    color: WILLIAMS_HEX,
  ...
  },
  {
    name: "Pierre Gasly",
    color: ALPINE_HEX,
    points: [29, 95, 75, 110, 23, 62, 42, 22, 26],
    standings: [15, 7, 10, 9, 14, 11, 10, 18, 10],
    thisYear: [0, 1, 9, 15, 16, 20, 26],
  },
  {
  ...
  },
  {
    name: "Isack Hadjar",
    color: RED_BULL_HEX,
    points: [null, null, null, null, null, null, null, 51, 29],
    standings: [null, null, null, null, null, null, null, 12, 8],
    thisYear: [0, 0, 4, 4, 4, 14, 29],
  },
  {
    name: "Lewis Hamilton",
    color: FERRARI_HEX,
    points: [408, 413, 347, 387.5, 240, 234, 223, 156, 90],
    standings: [1, 1, 1, 2, 6, 3, 7, 6, 2],
    thisYear: [0, 12, 33, 41, 51, 72, 90],
  },
  {
  ...
  },
  {
    name: "Liam Lawson",
    color: RB_HEX,
    points: [null, null, null, null, null, 2, 4, 38, 26],
    standings: [null, null, null, null, null, 20, 21, 14, 9],
    thisYear: [0, 0, 8, 10, 10, 16, 26],
  },
  {
    name: "Charles Leclerc",
    color: FERRARI_HEX,
    points: [39, 264, 98, 159, 308, 206, 356, 242, 75],
    standings: [13, 4, 8, 7, 2, 5, 3, 5, 4],
    thisYear: [0, 15, 34, 49, 59, 75, 75],
  },
  {
    name: "Arvid Lindblad",
    color: RB_HEX,
    points: [null, null, null, null, null, null, null, null, 13],
    standings: [null, null, null, null, null, null, null, null, 13],
    thisYear: [0, 4, 4, 4, 4, 5, 13],
  },
  {
  ...
  },
  {
    name: "Lando Norris",
    color: MCLAREN_HEX,
    points: [null, 49, 97, 160, 122, 205, 374, 423, 58],
    standings: [null, 11, 9, 6, 7, 6, 2, 1, 6],
    thisYear: [0, 10, 15, 25, 51, 58, 58],
  },
  {
    name: "Esteban Ocon",
    color: HAAS_HEX,
  ...
  },
  {
    name: "Oscar Piastri",
    color: MCLAREN_HEX,
    points: [null, null, null, null, null, 97, 292, 410, 60],
    standings: [null, null, null, null, null, 9, 4, 3, 5],
    thisYear: [0, 0, 3, 21, 43, 48, 60],
  },
  {
    name: "Kimi Räikkönen",
    color: AR_HEX,
  ...
  },
  {
    name: "George Russell",
    color: MERCEDES_HEX,
    points: [null, 0, 3, 16, 275, 175, 245, 319, 88],
    standings: [null, 20, 18, 15, 4, 8, 6, 4, 3],
    thisYear: [0, 25, 51, 63, 80, 88, 88],
  },
  {
    name: "Carlos Sainz",
    color: WILLIAMS_HEX,
  ...
  },
  {
    name: "Max Verstappen",
    color: RED_BULL_HEX,
    points: [249, 278, 214, 395.5, 454, 575, 437, 421, 43],
    standings: [4, 3, 3, 1, 1, 1, 1, 2, 7],
    thisYear: [0, 8, 8, 12, 26, 43, 43],
  },
  {
