...
export const types = [
  ...
  { name: "fire", color: red[700] },
  { name: "water", color: blue[700] },
  { name: "grass", color: green[800] },
  { name: "electric", color: yellow[700], inverted: true },
  { name: "psychic", color: pink[700] },
  { name: "ice", color: cyan[800] },
